            ...
            <div class="content-body">
                ...
                <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php else: ?>
                        <div class="user">
                    <?php endif; ?>
                    <span class="flex1"><?php echo e($usercounter - 1); ?></span>
                    <span class="flex2"><?php echo e($post->title); ?></span>
                    <span class="flex2"><?php echo e($post->user->name); ?></span>
                    <span class="flex2"><?php echo e($post->slug); ?></span>
                    <span class="flex2"><?php echo e($post->created_at->format('Y-m-d')); ?></span>
                    <span class="flex3 action-btns">
                        ...
                        <a onclick="showPostModel('<?php echo e(route('posts.show.model',$post->id)); ?>')" data-bs-toggle="modal" data-bs-target="#exampleModal">
                ...
                <?php $__currentLoopData = $deleted_posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deleted_post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $usercounter++ ?>
                    <?php if($usercounter % 2 == 0): ?>
                        <div class="user bg-deleted1">
                            ...
                            <?php endif; ?>
                                <span class="flex1"><?php echo e($usercounter - 1); ?></span>
                                <span class="flex2"><?php echo e($deleted_post->title); ?></span>
                                <span class="flex2"><?php echo e($deleted_post->user->name); ?></span>
                                <span class="flex2"><?php echo e($deleted_post->slug); ?></span>
                                <span class="flex2"><?php echo e(\Carbon\Carbon::parse($deleted_post->created_at)->format('Y-m-d')); ?></span>
                                <span class="flex3 action-btns">
                        <a href="<?php echo e(route('posts.show.deleted', $deleted_post->id)); ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-eye" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                <path d="M12 12m-3 0a3 3 0 1 0 6 0a3 3 0 1 0 -6 0m13 0c-2.667 4.667 -6 7 -10 7s-7.333 -2.333 -10 -7c2.667 -4.667 6 -7 10 -7s7.333 2.333 10 7"></path>
                            </svg>
                        </a>
                        <a href="<?php echo e(route('posts.force.delete', $deleted_post->id)); ?>" onclick="return confirm('You are about to delete this post forever.\nAre you sure want this?')">
                        ...
                        <a onclick="showPostModel('<?php echo e(route('deleted.posts.show.model',$deleted_post->id)); ?>')" data-bs-toggle="modal" data-bs-target="#exampleModal">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-zoom-in-area" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                               <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                               <path d="M15 13v4"></path>
                               <path d="M13 15h4"></path>
                        ...
                        <a href="<?php echo e(route('posts.restore', $deleted_post->id)); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\ITI 4 month\Labs\laravel\lap3\resources\views/posts/index.blade.php ENDPATH**/ ?>